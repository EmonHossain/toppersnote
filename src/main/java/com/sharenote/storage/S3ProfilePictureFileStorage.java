...
@Service
@ConditionalOnProperty(prefix = "storage.profile-pictures", name = "type", havingValue = "s3")
public class S3ProfilePictureFileStorage implements ProfilePictureFileStorage {

    private final ProfilePictureStorageProperties storageProperties;
    private final FileValidationService fileValidationService;
    private final S3Client s3Client;

    public S3ProfilePictureFileStorage(
